...
1. Answer ONLY with facts from the scene. 
2. If the scene does not contain the answer, say so briefly, then offer one related fact you DO have. Never invent project facts. Never go off-topic.
