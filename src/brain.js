...
2. If the data does not contain the answer, say offer something you DO know that are RELEVENT to what the user asked. NEVER invent specs, numbers, features or project names. NEVER go off-topic.
