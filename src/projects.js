...
export const PROJECTS = [
  {
    ...
    blurb: 'A fully rigged, game-ready character avatar — the same model serving as your guide right now.',
    specs: [
      'FBX 7.4 binary, single skinned mesh, real-time ready',
      '75-bone armature: full finger articulation, ears, tail, eye bones',
      'Facial blendshapes ("aa", "Blink") for lip-sync and expression',
    ...
    keywords: ['awd', 'avatar', 'character', 'rig', 'wade', 'model', 'skinned', 'puppet', 'guide'],
    buildModel() {
